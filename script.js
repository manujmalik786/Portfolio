...
interactiveElements.forEach((el) => {
  el.addEventListener('mouseenter', () => {
    bubbleCursor.style.transform = `translate(${bubbleX}px, ${bubbleY}px) scale(1.3)`;
    bubbleCursor.style.opacity = '0.8';
  });

  el.addEventListener('mouseleave', () => {
    bubbleCursor.style.transform = `translate(${bubbleX}px, ${bubbleY}px) scale(1)`;
